...
class SplitManagerTest: XCTestCase {
    ...
    override func setUp() {
        ...
        splitsStorage.update(splitChange: ProcessedSplitChange(
            activeSplits: loadedSplits,
            archivedSplits: [],
            changeNumber: 1,
            updateTimestamp: 100))
    ...
    func testInitialSplitLoaded() {
        ...
        XCTAssertEqual(
            names.sorted().joined(separator: ",").lowercased(),
            expectedSplitNames.joined(separator: ","),
            "Loaded splits names are not correct")
        ...
        XCTAssertEqual(
            splitLowercase?.name?.lowercased(),
            "sample_feature0",
            "Lowercase feature flag name is not equal to expected")
        ...
        XCTAssertEqual(
            splitUppercase?.name?.lowercased(),
            "sample_feature0",
            "Uppercase feature flag name is not equal to expected")
    ...
    func testSplitInfo() {
        ...
        XCTAssertEqual(
            treatments0?.sorted().joined(separator: ",").lowercased(),
            "t1_0,t2_0,t3_0,t4_0,t5_0,t6_0",
            "Split0 treatment names")
        ...
        XCTAssertEqual(
            treatments1?.sorted().joined(separator: ",").lowercased(),
            "t1_1,t2_1,t3_1,t4_1,t5_1,t6_1",
            "Split1 treatment names")
    ...
    func testAddOneSplit() {
        ...
        XCTAssertEqual(
            names.sorted().joined(separator: ",").lowercased(),
            "sample_feature0,sample_feature1,sample_feature2,sample_feature3,sample_feature4,sample_feature5,sample_feature6",
            "Added one feature flag name check")
    }
