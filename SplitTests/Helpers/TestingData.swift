...
"""
    ...
    static func escapedUpdateSplitsNotificationGzip(pcn: Int) -> String {
        ...
        return  """
{\\\"type\\\":\\\"SPLIT_UPDATE\\\",\\\"changeNumber\\\":1684265694505,\\\"pcn\\\":\(pcn),\\\"c\\\":1,\\\"d\\\":\\\"\\\"}
"""
    }
    ...
    static func flagSetsNotification(pcn: Int) -> String {
        ...
        return """
    {\\\"type\\\":\\\"SPLIT_UPDATE\\\",\\\"changeNumber\\\":2,\\\"pcn\\\":\(pcn),\\\"c\\\":0,\\\"d\\\":\\\"\\\"}
"""
    }

    static func encodedKeyListPayloadGzip() -> String {
        do {
            let notification = try Json.decodeFrom(json: kKeyListNotificationGzip, to: MembershipsUpdateNotification.self)
    ...
    static func encodedBoundedPayloadGzip() -> String {
        do {
            let notification = try Json.decodeFrom(json: kBoundedNotificationGzip, to: MembershipsUpdateNotification.self)
            return notification.data ?? ""
        } catch {
    ...
    static func encodedBoundedPayloadZlib() -> String {
        do {
            let notification = try Json.decodeFrom(json: kBoundedNotificationZlib, to: MembershipsUpdateNotification.self)
            return notification.data ?? ""
        } catch {
...
"""
 ...
 """
    ...
    static func membershipsNotificationSegmentRemovalMessage(type: NotificationType) -> String {
        let strType = (NotificationType.mySegmentsUpdate == type ? "memberships_ms_update" : "memberships_ls_update")
        var data = "\"{\\\"type\\\":\\\"\(strType)\\\",\\\"cn\\\":1702507130121,\\\"u\\\":3,\\\"c\\\":0, \\\"n\\\":[\\\"android_test\\\", \\\"ios_test\\\"]}\""
        if type == .mySegmentsUpdate {
            data = "\"{\\\"type\\\":\\\"\(strType)\\\",\\\"u\\\":3,\\\"c\\\":0, \\\"n\\\":[\\\"android_test\\\", \\\"ios_test\\\"]}\""
        }
...
"""
    ...
    static func membershipsNotificationSegmentRemovalMessage(type: NotificationType, segment: String, timestamp: Int) -> String {
        let strType = (NotificationType.mySegmentsUpdate == type ? "memberships_ms_update" : "memberships_ls_update")
        var data = "\"{\\\"type\\\":\\\"\(strType)\\\",\\\"cn\\\":1702507130121,\\\"u\\\":3,\\\"c\\\":0, \\\"n\\\":[\\\"\(segment)\\\"]}\""
        if type == .mySegmentsUpdate {
