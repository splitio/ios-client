...
class OneKeyPersistentMySegmentsStorageTests: XCTestCase {
    
    var mySegmentsStorage: OneKeyPersistentMySegmentsStorage!
    ...
    override func setUp() {
        ...
        mySegmentsStorage =
            DefaultOneKeyPersistentMySegmentsStorage(userKey: "dummyKey",
