...
class SplitsStorageTrafficTypesTests: XCTestCase {
    ...
    func testInitialtrafficTypes() {
        XCTAssertTrue(
            splitsStorage.isValidTrafficType(name: "trafficType0"),
            "Initial trafficTypes - trafficType0 should be in splitsStorage")
        XCTAssertTrue(
            splitsStorage.isValidTrafficType(name: "trafficType1"),
            "Initial trafficTypes - trafficType1 should be in splitsStorage")
        XCTAssertTrue(
            splitsStorage.isValidTrafficType(name: "trafficType2"),
            "Initial trafficTypes - trafficType2 should be in splitsStorage")
        XCTAssertTrue(
            splitsStorage.isValidTrafficType(name: "trafficType3"),
            "Initial trafficTypes - trafficType3 should be in splitsStorage")
    }
