...
"""
    ...
    func testProcessMySegmentUpdateUnbounded() throws {
        ...
        let mySegmentUpdate = try notificationParser.parseMembershipsUpdate(jsonString: incoming!.jsonData!, type: .mySegmentsUpdate)
    ...
    func testProcessMySegmentUpdateAllFields() throws {
        ...
        let incoming = notificationParser.parseIncoming(jsonString: json)
        let mySegmentUpdate = try notificationParser.parseMembershipsUpdate(jsonString: incoming!.jsonData!, type: .myLargeSegmentsUpdate)
