...
class DefaultSynchronizer: Synchronizer {
    ...
    func notifyRuleBasedSegmentsUpdated(forKey key: String, metadata: EventMetadata? = nil) {
        byKeySynchronizer.notifyRuleBasedSegmentsUpdated(forKey: key, metadata: metadata)
    }
