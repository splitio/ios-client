...
protocol HttpSplitFetcher {
    func execute(since: Int64, rbSince: Int64?, till: Int64?, headers: HttpHeaders?, spec: String?) throws
...
class DefaultHttpSplitFetcher: HttpSplitFetcher {
    ...
    func execute(
        ...
        spec: String? = nil) throws -> TargetingRulesChange {
