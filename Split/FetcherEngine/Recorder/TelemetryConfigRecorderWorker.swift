...
class TelemetryConfigRecorderWorker: RecorderWorker {
    ...
    init(
        telemetryConfigRecorder: HttpTelemetryConfigRecorder,
    ...
    private func buildTelemetryConfig() -> TelemetryConfig {
        let rates = TelemetryRates(
            splits: splitConfig.featuresRefreshRate,
        ...
        let urlOverrides = TelemetryUrlOverrides(
            sdk: endpoints.isCustomSdkEndpoint,
        ...
        return TelemetryConfig(
            streamingEnabled: splitConfig.streamingEnabled,
            rates: rates,
            ...
            integrations: nil,
            flagSetsTotal: telemetryConsumer.getTotalFlagSets(),
            flagSetsInvalid: telemetryConsumer.getInvalidFlagSets(),
            tags: telemetryConsumer.popTags())
    }
}
