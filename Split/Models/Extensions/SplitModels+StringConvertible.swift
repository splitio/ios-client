...
extension DependencyMatcherData {
    override public var debugDescription: String {
        var output = "DependencyMatcherData {\n"
        if let split = split {
            output += "split = \(split) \n"
        } else {
            output += "split = nil\n"
...
extension UnaryNumericMatcherData {
    override public var debugDescription: String {
        var output = "UnaryNumericMatcherData {\n"
        if let dataType = dataType {
            output += "dataType = \(String(reflecting: dataType)) \n"
        } else {
            output += "dataType = nil\n"
...
extension UserDefinedSegmentMatcherData: CustomDebugStringConvertible {
    var debugDescription: String {
        var output = "UserDefinedSegmentMatcherData {\n"
...
extension UserDefinedLargeSegmentMatcherData: CustomDebugStringConvertible {
    var debugDescription: String {
        var output = "UserDefinedLargeSegmentMatcherData {\n"
...
extension WhitelistMatcherData {
    override public var debugDescription: String {
        var output = "WhitelistMatcherData {\n"
