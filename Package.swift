...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://aws-development-split-public.s3.amazonaws.com/mobile/ios-xcframework/SplitXcFramework_2.0.0.zip",
            checksum: "38420a48e3c1b2b33f7202264053fae921510cc970ce651d1ccd804ee020340e"
        ),
        .target(
            name: "JFBCrypt",
