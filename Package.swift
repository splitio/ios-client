...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://aws-development-split-public.s3.amazonaws.com/mobile/ios-xcframework/Split_2.0.0.zip",
            checksum: "c1b74c72be4f9a9cc3cd22452f94751bfd723fc24eedec9ca3d4326aa27afe5a"
        ),
        .target(
            name: "JFBCrypt",
